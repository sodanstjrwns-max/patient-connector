...
function render() {
 ...
 <section id="library-section"><header class="section-heading"><div class="row"><h2>${state.favorites ? "즐겨찾기 라이브러리" : "설명자료 라이브러리"}</h2><span class="badge badge-accent">${PC.esc(state.specialty)}</span></div><p class="desktop-only">우리 병원에 맞는 설명을 찾아보세요</p></header>
